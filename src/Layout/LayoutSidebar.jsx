...
const LayoutSidebar = () => {
  ...
  return (
    <div className="flex w-screen h-screen text-sm bg-slate-100 " >
      <div className={`flex flex-col flex-1 gap-5 overflow-y-auto scroll-smooth   text-white items-center  h-screen  w-full bg-black/80 px-2 ${side ? "max-w-[100px] transform duration-300 " : "max-w-[230px]  transform duration-300"}`} onMouseEnter={() => isActive && setSide(false)}  onMouseLeave={() => isActive && setSide(true)} >
      ...
      <div className="flex-1 h-screen bg-[180, 180, 180] px-5 overflow-y-auto ">
