...
import fintgerpint from "/image copy 8.png"
import puzzle from "/puzzle-piece.png"
...
const Widgets = () => {
  ...
  const iconCard = [
    { bg_color : "red" , img_icon : suitcase},
    { bg_color : "rgb(12, 250, 12)" , img_icon : puzzle},
    { bg_color : "rgb(203, 240, 252)" , img_icon : fintgerpint},
  ]

  return (
    <div className='w-full h-[90%] '>
        <div className='flex gap-14' >
          <div className='flex-1 w-full bg-white h-[330px] pb-2 rounded-md shadow-[0_0_15px_rgba(0,0,0,0.2)] px-5 ' >
          ...
          <div className='flex-1 bg-white w-full h-[360px]  pb-2 rounded-md shadow-[0_0_15px_rgba(0,0,0,0.2)] px-5 '>
          ...
          <div className='flex mt-20 text-gray-600' >
            ...
            <div className='flex-1 gap-2 flex' >
                ...
                <div className='flex-1 flex  flex-col  px-12 py-5  text-sm  items-center ' >
                    <h6 >Freelancer</h6>
                    <span className='p-8 rounded-full text-black my-3 bg-white shadow-[0_0_10px_rgba(0,0,0,0.2)]'>
                        <RiSofaFill size={50} />
                    </span>
            ...
            <div className='w-[75%] mb-10 h-[265px] relative flex  flex-col items-center  mt-10 shadow-[0_0_15px_rgba(0,0,0,0.2)] bg-white ' >
                ...
                <div className='absolute -bottom-[50px] rounded-full' >
                  <img src="public/image copy 9.png" alt="" className='w-24 h-24 rounded-full shadow-[o_o_15px_rgba(0,0,0,0.2)]' />
                </div>
            </div>
            </div>
            <div className='flex-1 ml-10 flex ' >
              ...
              <div className='absolute flex justify-between items-center h-[560px]  flex-col h -left-7 top-0 ' >
              {
                iconCard.map((val, index) => (
                  <span className='w-16 h-16 flex items-center justify-center rounded-full' style={{backgroundColor: val.bg_color}} >
                      <img src={val.img_icon} alt="" className='w-10 h-10 ' />
                  </span>
                ))
              }
              </div>
              </div>
              <div className='h-full -ml-3 flex flex-col justify-between' >
                  <div className='w-full bg-white relative py-5 px-5 text-gray-500 rounded-md flex flex-col gap-3 h-auto shadow-[0_0_15px_rgba(0,0,0,0.2)] ' >
                      ...
                      <div  className=" bg-white  w-5 absolute top-3 -left-3  h-10" style={{ clipPath: "polygon(0 50%, 100% 0, 100% 100%)" }}></div>
                  </div>
                  <div className='w-full bg-white relative py-5 px-5 text-gray-500 rounded-md flex flex-col gap-3 h-auto shadow-[0_0_15px_rgba(0,0,0,0.2)] ' >
                      <button className='w-32 h-7 rounded-full bg-red-500 text-white' >SOME TITLE</button>
                      <p>Wifey made the best Father's Day meal ever. So thankful so happy so blessed. Thank you for making my family We just had fun with the “future” theme !!! It was a fun night all together ... The always rude Kanye Show at 2am Sold Out Famous viewing @ Figueroa and 12th in downtown.</p>
